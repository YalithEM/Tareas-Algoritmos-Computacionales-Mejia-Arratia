...
begin 
	plot(sin,-π:d:π, xlabel = "x", color = "blue", label = "sin(x)", title = "Funciones tigonométricas") 
	plot!(cos,-π:d:π, color = "black", label = "cos(x)") 
end
...
@gif for i in (0:0.01:2π) 
	surface((0:0.05:2π),(0:0.05:π*i),H1, color = :cool) 
    end
end
